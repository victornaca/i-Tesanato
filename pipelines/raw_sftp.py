...
def merge_parquet_files_sftp():
    source_directory = "datalake/pre-process/csv-price-search/new"
    destination_directory = "datalake/raw-data/csv-price-search"
    old_directory = "datalake/pre-process/csv-price-search/old"
    folder_name = "price"
